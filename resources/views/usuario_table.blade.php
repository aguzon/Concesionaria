 ...
 <div id="tf-services" class="text-center">
        <div class="container">
            <div class="section-title center">
                <h2>Administracion <strong>de Clientes</strong></h2>
                <div class="line">
                    <hr>
                </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 service">
                    ...
                    <h4><strong><input type="button" class="btn btn-danger" value="Clientes" onClick="window.location.href='table_usuario'"></strong></h4>
                </div>

                <div class="col-md-3 col-sm-6 service">
                    <i class="fa fa-user-circle" aria-hidden="true"></i>
                    <h4><strong><input type="button" class="btn btn-danger" value="Empleados" onClick="window.location.href='table_employe'"></strong></h4>
                </div>

                <div class="col-md-3 col-sm-6 service">

                    <i class="fa fa-user-circle" aria-hidden="true"></i>
                    <h4><strong><input type="button" class="btn btn-danger" value="Area" onClick="window.location.href='table_area'"></strong></h4>
                </div>
            ...
            <div class="space"></div>
            <small><h3><em>Lista de todos los clientes:</em></h3></small>
            <div class="clearfix"></div>
        ...
        <!-- Indica que hay que tener cuidado con la acción asociada al botón -->
            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal2">Agegar Cliente</button>
    </div>
</div>
